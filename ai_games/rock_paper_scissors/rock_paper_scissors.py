...
if strategy_choice == "1":
    print(Fore.CYAN + "AI strategy: Random\n")
elif strategy_choice == "2":
    print(Fore.CYAN + "AI strategy: Frequency Analysis\n")
else:
    print(Fore.CYAN + "AI strategy: Pattern Recognition\n")
...
while playing:
    ...
    while player_mv not in MOVES:
        ...
        if raw in MOVES:
            ...
            print(Fore.RED + "Invalid input. Please type rock, paper, or scissors." + Style.RESET_ALL)
    ...
    print()
    print(Fore.YELLOW + "  " + player_name + " : " + p_emoji + " " + player_mv.capitalize())
    print(Fore.BLUE + "  AI       : " + a_emoji + " " + ai_mv.capitalize())
    print()
    ...
    if outcome == "player":
        print(Fore.GREEN + Style.BRIGHT + "  You win this round! " + ai_mv.capitalize() + " loses to " + player_mv.capitalize() + ".")
        player_score = player_score + 1
    elif outcome == "ai":
        print(Fore.RED + Style.BRIGHT + "  AI wins this round! " + player_mv.capitalize() + " loses to " + ai_mv.capitalize() + ".")
        ai_score = ai_score + 1
    else:
